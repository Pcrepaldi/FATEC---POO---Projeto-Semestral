 ...
 * @author lubuntu
 */
public class Cad_Professor_1 extends javax.swing.JFrame {

    /**
     * Creates new form Cad_Usuario
     */

    public Cad_Professor_1() {
        initComponents();
    }
    ...
    private void jButtonAvancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAvancarActionPerformed
        ...
        String num_casa = jTextFieldNumero.getText();
        String bairro = jTextFieldBairro.getText();
        String cidade = jTextFieldCidade.getText();
        String estado = jComboBoxEstado.getSelectedItem().toString();

        System.out.println("------------------------------------");
        System.out.println("Nome = " + "'" + nome + "'" + "'" + nome.length()+"'");
        System.out.println("RG = " + "'" + rg + "'" + rg.length()+"'");
        System.out.println("CPF = " + "'" + cpf + "'" + cpf.length()+"'");
        System.out.println("Sexo = " + "'" + sexo + "'" + sexo.length()+"'");
        System.out.println("Email = " + "'" + email + "'" + email.length()+"'");
        System.out.println("Celular = " + "'" + celular + "'" + celular.length()+"'");
        System.out.println("Rua = " + "'" + rua + "'" + rua.length()+"'");
        System.out.println("Num = " + "'" + num_casa + "'" + num_casa.length()+"'");
        System.out.println("Bairro = " + "'" + bairro + "'" + bairro.length()+"'");
        System.out.println("Cidade = " + "'" + cidade + "'" + cidade.length()+"'");
        System.out.println("Estado = " + "'" + estado + "'" + estado.length()+"'");
        System.out.println("------------------------------------");
        */
        /*
        ...
        */
        if(vazio == false){
            ...
            try{
                ...
                //System.out.println("Data de Nascimento pega do USUARIO e convertida dd/MM/yy= " + formato.parse(jTextFieldData_Nasc.getText()));
                ...
                Cad_Professor_2 cad = new Cad_Professor_2();
                ...
                JOptionPane.showMessageDialog(null,
                 "Erro = "+ex.getMessage(),"Professor",0);
            }
            /*
            System.out.println("------------------------------------");
            ...
            System.out.println("Num = " + usuario.getNum_casa());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cad_Professor_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cad_Professor_1().setVisible(true);
            }
        });
    }
