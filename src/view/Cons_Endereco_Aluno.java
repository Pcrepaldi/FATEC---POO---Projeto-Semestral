 ...
 * @author lubuntu
 */
public class Cons_Endereco_Aluno extends javax.swing.JFrame {
    ...
    public void preencher_tabela(){
        ...
        //ArrayList<Aluno> lista = ac.buscar();
        ...
        if(jComboConsulta.getSelectedIndex() == 0){
            ...
            for (int i = 0; i < lista.size(); i++) {        
                if(jTextFieldValor.getText().equalsIgnoreCase(lista.get(i).getNome())){
            ...
            for (int i = 0; i < lista.size(); i++) {        
                if(jTextFieldValor.getText().equalsIgnoreCase(lista.get(i).getCidade())){
    ...
    private void initComponents() {
        ...
        jLabelValor.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        jLabelValor.setText(" o Nome:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cons_Endereco_Aluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cons_Endereco_Aluno().setVisible(true);
            }
        });
    }
