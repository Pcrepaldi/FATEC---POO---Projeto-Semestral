 ...
 * @author lubuntu
 */
public class Cons_Endereco_Professor extends javax.swing.JFrame {

    DefaultTableModel modelo = new DefaultTableModel();

    public Cons_Endereco_Professor() {
        initComponents();
        preencher_tabela();
        jLabelDigite.setVisible(false);
        jLabelCampo.setVisible(false);
    ...
    public void preencher_tabela(){
        ...
        if(jComboConsulta.getSelectedIndex() == 0){
            ...
            ArrayList<Professor> listaPersonalizada2 = pDAO.consultarProfessorPersonalizada("cidade", jTextFieldValor.getText());
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Rua", "Número", "Bairro", "Cidade", "Estado"
            }
        ) {
        ...
        jComboConsulta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Nome", "Cidade" }));
        ...
        jLabelCampo.setFont(new java.awt.Font("SansSerif", 1, 16)); // NOI18N
        jLabelCampo.setText(" o Nome:");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String nome = String.valueOf(modelo.getValueAt(row, 0));
        String rua = String.valueOf(modelo.getValueAt(row, 1));
        String num = String.valueOf(modelo.getValueAt(row, 2));
        String bairro = String.valueOf(modelo.getValueAt(row, 3));
        String cidade = String.valueOf(modelo.getValueAt(row, 4));
        String estado = String.valueOf(modelo.getValueAt(row, 5));

        jLabelNome.setText(nome);
        jLabelRua.setText(rua);
        jLabelNumero.setText(num);
        jLabelBairro.setText(bairro);
        jLabelCidade.setText(cidade);
        jLabelEstado.setText(estado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cons_Endereco_Professor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cons_Endereco_Professor().setVisible(true);
            }
        });
    }
