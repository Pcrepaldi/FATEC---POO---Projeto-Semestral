 ...
 * @author lubuntu
 */
public class Consultar_Alterar_Excluir_Treino extends javax.swing.JFrame {

    DefaultTableModel modelo = new DefaultTableModel();
    DefaultTableModel modelo2 = new DefaultTableModel();

    public Consultar_Alterar_Excluir_Treino() {
        initComponents();
    ...
    public void limpar(){
        jComboConsulta.setSelectedIndex(0);
        jTextFieldValor.setText(null);
        jTextFieldCod_Treino.setText(null);
    ...
    public void preencher_tabela(){
        ...
        if(jComboConsulta.getSelectedIndex() == 0){
            ArrayList<Treino> lista = tDAO.consultarTreino();
            for (int i = 0; i < lista.size(); i++) {        
                modelo.addRow(new Object[]{
                    lista.get(i).getCod_treino(),    
                    lista.get(i).getNome(),
                    lista.get(i).getObjetivo(),
                    });
            }
        }else if(jComboConsulta.getSelectedIndex() == 1){
            ArrayList<Treino> lista = tDAO.consultarTreinoCodigo("cod_treino", jTextFieldValor.getText());
            for (int i = 0; i < lista.size(); i++) {        
                modelo.addRow(new Object[]{
                    lista.get(i).getCod_treino(),    
                    lista.get(i).getNome(),
            ...
            ArrayList<Treino> lista = tDAO.consultarTreinoPersonalizada("nome", jTextFieldValor.getText());
            for (int i = 0; i < lista.size(); i++) {        
                modelo.addRow(new Object[]{
                    lista.get(i).getCod_treino(),    
                    lista.get(i).getNome(),
    ...
    private void initComponents() {
        ...
        jTextFieldCod_Treino = new javax.swing.JTextField();
        ...
        setTitle("GymManager - Consulta Treino");
        setResizable(false);
        ...
        jLabel1.setText("Consulta de Treinos");
        ...
        jComboConsulta.setBackground(new java.awt.Color(255, 255, 255));
        jComboConsulta.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jComboConsulta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Código", "Nome" }));
        ...
        jTextFieldCod_Treino.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jTextFieldCod_Treino.setEnabled(false);

        jLabelNome1.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabelNome1.setText("Objetivo");

        jTextAreaObjetivo.setColumns(20);
        jTextAreaObjetivo.setLineWrap(true);
        jTextAreaObjetivo.setRows(5);
        jScrollPane2.setViewportView(jTextAreaObjetivo);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldCod_Treino, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabelNome14)
                        .addComponent(jLabelNome12)
                        .addComponent(jTextFieldCod_Treino, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addComponent(jLabelNome1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jComboBoxExercicios.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N

        jLabel4.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Tabela de Exercícios do Treino");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jComboBoxExercicios, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jComboBoxExercicios, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        treino.setCod_treino(Integer.parseInt(jTextFieldCod_Treino.getText()));
        treino.setNome(jTextFieldNome.getText());
        treino.setObjetivo(jTextAreaObjetivo.getText());
        
        TreinoDAO tDAO = new TreinoDAO();
        tDAO.alterarTreino(treino);
    ...
    private void jButtonConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConsultarActionPerformed
        if(jComboConsulta.getSelectedIndex() == 1 || jComboConsulta.getSelectedIndex() == 2){
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        int cod_treino = Integer.parseInt(String.valueOf(jTable1.getValueAt(row, 0)));
        
        TreinoDAO tDAO = new TreinoDAO();
        tDAO.excluirTreino(cod_treino);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String cod_treino = String.valueOf(modelo.getValueAt(row, 0));
        String nome = String.valueOf(modelo.getValueAt(row, 1));
        String objetivo = String.valueOf(modelo.getValueAt(row, 2));

        jTextFieldCod_Treino.setText(cod_treino);
        jTextFieldNome.setText(nome);
        jTextAreaObjetivo.setText(objetivo);
        
        modelo2.setRowCount(0);
        TreinoDAO tDAO = new TreinoDAO();
        ArrayList<Exercicio_Treino> lista = tDAO.consultarExercicioTreino(Integer.parseInt(cod_treino));
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        for(int i=0; i<jTable2.getRowCount(); i++){
            String exerc = String.valueOf(jTable2.getValueAt(i, 1));
        ...
        if(verificador == 0){
            ...
            int row = jTable1.getSelectedRow();
            String cod_treino = String.valueOf(modelo2.getValueAt(row, 0));
            
            TreinoDAO tDAO = new TreinoDAO();
            ArrayList<Exercicio> lista2 = eDAO.consultarExercicioPersonalizada("nome", exercicio);
            
            for(int i=0; i<lista.size(); i++){
                tDAO.inserirExercicioTreinoAlteração(lista2.get(i).getCod_exerc(), Integer.parseInt(cod_treino));
            }
    ...
    private void jButtonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoverActionPerformed
        ...
        int cod_exercicio = Integer.parseInt(jTable2.getValueAt(row, 0).toString());
        
        int row2 = jTable1.getSelectedRow();
        int cod_treino = Integer.parseInt(jTable1.getValueAt(row2, 0).toString());

        ExercicioDAO eDAO = new ExercicioDAO();
        eDAO.excluirExercicioAlteracao(cod_exercicio, cod_treino);
        ...
        if(jTable2.getSelectedRow() >= 0){
            ...
            JOptionPane.showMessageDialog(null, "Selecione uma linha da Treino para remover!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Alterar_Excluir_Treino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultar_Alterar_Excluir_Treino().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldCod_Treino;
